...
def random_forest(X, y):
    ...
    # Split the data into training and testing sets (now we have enough test and training samples due to smote)
    X_train, X_test, y_train, y_test = train_test_split(X_resampled, y_resampled, test_size=0.3, random_state=42)
    
    # Build the RF-estimator + use cross validation instead of splitting the data 
