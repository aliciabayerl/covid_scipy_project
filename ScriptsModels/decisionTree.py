...
# definition of the decision tree approach as a function to make it accessible form other skrips
def decision_tree(X, y):
    ...
    # Calculate further scores for plotting the ROC-Curve
    ...
    # return the ROC measures to make it available for the ROC curve plotting function
